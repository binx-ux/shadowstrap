    ...
    public partial class App : Application
    {
...
#endif
        public const string ProjectOwner = "binx-ux";
        public const string ProjectRepository = "binx-ux/shadowstrap";
        public const string ProjectDownloadLink = "https://github.com/binx-ux/shadowstrap";
        public const string ProjectHelpLink = "https://github.com/binx-ux/shadowstrap/wiki";
        public const string ProjectSupportLink = "https://github.com/binx-ux/shadowstrap/issues/new";
        ...
        public static string ConstructShadowstrapWebUrl()
        {
            ...
            if (Settings.Prop.WebEnvironment == WebEnvironment.Production || !Settings.Prop.DeveloperMode)
                return "services.binx-ux.com";

            string? sub = Settings.Prop.WebEnvironment.GetDescription();
            return $"services-{sub}.binx-ux.com";
        }
